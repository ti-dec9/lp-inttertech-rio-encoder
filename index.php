...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>ENCODER INCREMENTAL EIXO VAZADO HS35N 10249WBWW - INTTERTECH RIO</title>
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-xxl-6 col-xl-5 col-md-12 cus-index d-block d-sm-none text-center">
                            <div class="sec-img position-relative">
                                <img src="assets/images/ENCODER-INCREMENTAL-EIXO-VAZADO-HS35N-10249WBWW-intertench-rio.webp"
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th scope="col" class="color-blue">Código 2 <br> PPR</th>
                                        <th scope="col" class="color-blue">Código 3 <br> Eixo</th>
                                        <th scope="col" class="color-blue">Código 4 <br> Fixação</th>
                                        <th scope="col" class="color-blue">Código 5 <br> Saída</th>
                                        <th scope="col" class="color-blue">Código 6 <br> Conexão</th>
                                        <th scope="col" class="color-blue">Código 7 <br> Plug</th>
                                    </tr>
                                </thead>
                                <tbody class="text-center">
                                    <tr>
                                        <th scope="row"></th>
                                        <td>
                                            <span style="border: 1.5px solid #000;  padding: 10px;"></span>
                                            <span style="border: 1.5px solid #000;  padding: 10px;"></span>
                                            <span style="border: 1.5px solid #000;  padding: 10px;"></span>
                                            <span style="border: 1.5px solid #000;  padding: 10px;"></span>
                                        </td>
                                    ...
                                    <tr>
                                        <th scope="row" class="color-blue" style="width: 150px;">HS35N</th>
                                        <td style="width: 150px;"><span class="color-blue fw-bold">1024</span></td>
                                        <td style="width: 150px;">
                                            <ul class="list-unstyled text-left ms-lg-2">
                                                <li><span class="color-blue fw-bold">9</span> 15mm</li>
                                            </ul>
                                        </td>
                                        <td style="width: 150px;">
                                            <ul class="list-unstyled text-left ms-lg-2">
                                        ...
                                        <td style="width: 150px;">
                                            <p><strong>Prensa cabo</strong></p>
                                            <ul class="list-unstyled text-left ms-lg-2">
                                                <li><span class="color-blue fw-bold">W</span> 0,35 metros</li>
                                            </ul>
                                        </td>
                                        <td style="width: 150px;">
                                            <ul class="list-unstyled text-left ms-lg-2">
                                                <li><span class="color-blue fw-bold">W</span> Macho com Flange</li>
                                            </ul>
                                        </td>
                                    </tr>
                                </tbody>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-md-6">
                        <div class="section-header text-center">
                            ...
                            <p>Saiba mais sobre o que o Encoder Incremental Eixo Vazado HS35N pode oferecer</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="overlay pt-120 pb-120">
            <div class="container wow fadeInUp">
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-md-6">
                        <div class="section-header text-center">
                            <h2 class="title">5 motivos para usar o Encoder Incremental Eixo Vazado HS35N 10249WBWW</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="main-content">
                            ...
                            <div class="right-area">
                                <div class="section-area">
                                    <h5>ENCODER INCREMENTAL EIXO VAZADO HS35N 10249WBWW</h5>
                                </div>
